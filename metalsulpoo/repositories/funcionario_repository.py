...
class FuncionarioRepository:
    ...
    """
    ESSE METODO (def criar_funcionario) DEVE SERVIR PARA REAPROVEITAMENTO. ANALISANDO O METODO LISTAR VERIFICA-SE O USO DE UMA ESTRUTURA PARECIDA COM NOME=REGISTRO[1],
    CPF=REGISTRO[2], ESSE MESMO CÓDIGO SERÁ NECESSARIO NO METODO ATUALIZAR().
    VAMOS CRIA-LO PARA AUXILIAR FUTUROS METODOS QUE REUPEREM DADOS DE MANEIRA IGUAL. 
    """
